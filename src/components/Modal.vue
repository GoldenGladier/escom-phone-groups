...
<transition name="fade">
  ...
  <div class="background-modal" v-if="open">
      <div class="modal" v-click-outside="modalDeactivate" v-on:keyup.enter="createSubject">
          <!-- TITULO -->
          ...
          <div class="modal-content" v-else>
            ...
            <input v-model="name" autocomplete="off" type="text" class="input input-modal" 
            ...
            <div class="link-modal" v-on:click="linkFocus">
              ...
              <input v-model="link" autocomplete="off" type="text" class="input input-modal-link" placeholder="Ejemplo: https://chat.whatsapp.com/Fj9kBy8ALfs1PBLwCAqkm8" 
          ...
          <div class="modal-footer">
              ...
              <button class="button btn-modal btn-create" @click="createSubject">Crear</button>
          </div>
      </div>
  </div>
  ...
  methods : {
    ...
    createSubject : function(){
        if(this.name != '' && this.link != ''){
            ...
            this.$emit("create-subject", this.careerKey, this.groupName, this.name, this.link);
        }
        else{
            if(this.name == ''){
                this.nameAlert = true;
